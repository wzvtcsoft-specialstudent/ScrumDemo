<template>
  <div class="board-main">
    <div class="board-title">
      <div class="menu" @click="clickMenu">
        ...
        <div class="menu-item" v-show="menuState" @mouseleave="menuState = false">
          ...
          <router-link to="/historysprint" tag="span" class="link-item">History Sprint</router-link>
        </div>
      </div>
    ...
    <div class="board">
      <div class="board-mune">
        <div class="sprint-title">
          <div class="sprint-name"><span style="font-size:20px;">里程碑</span></div>
          <div class="sprint-rate"></div>
          <div class="sprint-time"><span style="font-size:14px;">2019/06/14 - 2019/07/28</span></div>
